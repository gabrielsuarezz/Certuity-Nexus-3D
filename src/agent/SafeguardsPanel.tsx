...
const META: Record<SafeguardKind, { color: string; tag: string }> = {
  grounded: { color: '#2f8f68', tag: 'Grounded' },
  map: { color: '#2e5788', tag: 'Map' },
  approval: { color: '#9c7a34', tag: 'Approval' },
  blocked: { color: '#c2603f', tag: 'Blocked' },
  scope: { color: '#7a5fa8', tag: 'Advisor' },
  redacted: { color: '#667585', tag: 'Masked' },
}
  ...
  return (
    <div className="hidden w-full sm:block">
      <div className="glass hairline pointer-events-auto overflow-hidden rounded-2xl">
        <div className="flex items-center gap-2.5 border-b border-ink/10 px-3.5 py-2.5">
          <span
          ...
          >
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" aria-hidden>
              <path d="M12 3l7 3v5c0 4.4-3 7.9-7 9-4-1.1-7-4.6-7-9V6l7-3z" stroke="#E2C88C" strokeWidth="1.6" strokeLinejoin="round" />
              <path d="M9 12l2 2 4-4" stroke="#E2C88C" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </span>
          <div>
